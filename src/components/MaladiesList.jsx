...
const MaladiesList = ({ temperature, humidity, dissolvedOxygen, isOutside, language }) => {
  ...
  return (
    <div>
      {diseases.map((diseaseKey, index) => {
        ...
        const risk = diseaseRiskCalculators[normalizedKey](temperature, humidity, dissolvedOxygen, isOutside);
